...
REPOOUTPUT=$(curl -k -u $TL_USER:$TL_PASS \
  ...
  https://console-master-test.rbenavente.demo.twistlock.com/api/v1/coderepos?id=rbenavente%2Fevil_petclinic&limit=15&offset=0&project=Central+Console&reverse=true&sort=vulnerabilityRiskScore)
